...
export default function StickerPeel({
  ...
  useEffect(() => {
    ...
    draggableInstanceRef.current = inst;
  ...
  useEffect(() => {
    const updateLight = (e: MouseEvent) => {
      ...
      if (!rect || !pointLightRef.current || !pointLightFlippedRef.current)
        return;
  ...
  const filterDrop = `url(#${fid}-drop)`;
  const filterPl = `url(#${fid}-pl)`;
  const filterPlf = `url(#${fid}-plf)`;
  const filterExp = `url(#${fid}-exp)`;
  ...
  return (
    ...
    >
      ...
      <div className="sticker-container" ref={containerRef}>
        <div className="sticker-main" style={{ filter: filterDrop }}>
          <div className="sticker-lighting" style={{ filter: filterPl }}>
            {/* eslint-disable-next-line @next/next/no-img-element -- peel effect requires raw img */}
            <img
              src={imageSrc}
              alt=""
        ...
        <div className="flap">
          <div className="flap-lighting" style={{ filter: filterPlf }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src={imageSrc}
              alt=""
              className="flap-image"
              style={{ filter: filterExp }}
              draggable={false}
              onContextMenu={(e) => e.preventDefault()}
            />
          </div>
